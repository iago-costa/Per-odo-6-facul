...
def requisicoes():
    ...
    for item in range(0, 20):
        time.sleep(8)
        print(exclusao.concorrer("Cliente1", 'Barba', str(lista1[item]), str(uri_cliente)))

        time.sleep(1)
        print(exclusao.concorrer("Cliente1", 'Bigode', str(lista2[item]), str(uri_cliente)))   # call method normally

        time.sleep(3)
        print(exclusao.concorrer("Cliente1", 'Cabelo', str(lista3[item]), str(uri_cliente)))   # call method normally
