...
# while True:
    for item in range(0, 20):
        time.sleep(6)
        print(exclusao.concorrer("Cliente1", 'Barba', str(item), str(uri_cliente)))
        ...
        #         print(exclusao.concorrer("Cliente1", 'Barba', str(item), str(uri_cliente)))   # call method normally
        #     # print(lista_grupo_cliente[i][3])

        time.sleep(6)
        print(exclusao.concorrer("Cliente1", 'Bigode', str(item), str(uri_cliente)))   # call method normally
        ...
        time.sleep(6)
        print(exclusao.concorrer("Cliente1", 'Cabelo', str(item), str(uri_cliente)))   # call method normally
