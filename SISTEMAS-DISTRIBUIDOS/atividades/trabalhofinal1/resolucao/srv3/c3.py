...
private_bytes_key = private_key.private_bytes(
    ...
    encryption_algorithm=serialization.BestAvailableEncryption(b'3323'))
...
clientSocket.sendto("par3_pub_key".encode(), (serverName, serverPort)) # enviando o nome do par
...
try:
    ...
    while 1:
        ...
        if (sentence == "file"):
            ...
            sentence = input(
                'Confirme de qual endereço (processo) deseja receber o arquivo? (mande id do par escolhido e o seu id de par ex. 2 3 - id_outro=2 id_seu=3)'
            )
            ...
            password = b'3323' # senha para ler a chave privada

            #lendo a chave privada
            with open("par3_pri_key.pem", "rb") as key_file:
