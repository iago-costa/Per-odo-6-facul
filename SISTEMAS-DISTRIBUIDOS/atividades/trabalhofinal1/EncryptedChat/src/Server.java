 ...
 *
 * Compile	$javac Server.java Run $java Server
 *
 *
 * References:
 ...
 * public class Server
 *
 * The server program will open a socket listening on TCP port 8002. Client
 * program will establish connection over the socket and send encrypted messages
 * to the server.
 *
 *
 *
