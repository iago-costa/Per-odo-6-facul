...
echo "<br/>";
echo 'cvv_cartao_hospedagem: ', $_POST['cvv_cartao_hospedagem'];
echo "<br/>";
...
if ($parcela_x12_hospedagem == 'on') {
    $parcela_hospedagem = 'x12';
} elseif ($parcela_x6_hospedagem == 'on'){
    $parcela_hospedagem = 'x6';
}elseif ($parcela_x1_hospedagem = 'on'){
    $parcela_hospedagem = 'x1';
}
echo "<br/>";
...
//  "parcela_hospedagem"=> $parcela_hospedagem
// );
